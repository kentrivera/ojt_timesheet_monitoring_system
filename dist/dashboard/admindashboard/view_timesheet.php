...
<body class="bg-gray-100">
    ...
    <div class="flex">
        ...
        <main class="flex-1 p-4">
            ...
            <script src="admin_view_timesheet.js"></script>
            ...
            <script>
                ...
                document.getElementById('downloadButton').addEventListener('click', function() {
                    ...
                    const traineeId = new URLSearchParams(window.location.search).get('id');
                    ...
                    // Fetch trainee name (replace with your actual API endpoint)
                    fetch(`get_trainee_name.php?id=${traineeId}`)
                        .then(response => response.json())
                        .then(data => {
                            const traineeName = data.name.replace(/\s+/g, '_'); // Replace spaces with underscores
