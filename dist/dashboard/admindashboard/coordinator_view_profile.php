...
<body class="bg-gray-50">
    ...
    <div class="mb-10">
        <?php include '../coordinators/nav/top-nav.php'; ?>
    </div>
                ...
                <div class="w-full md:w-2/3 pl-0 md:pl-6 mt-6 md:mt-0 stats-section">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                        ...
                        <div class="bg-gradient-to-r from-secondary-light to-secondary p-4 sm:p-5 rounded-lg shadow-sm hover:shadow-md transition text-white">
                            ...
                            <a href="coordinators_weekly_hours.php?id=<?php echo $trainee_id; ?>" class="mt-2 inline-block px-3 sm:px-4 py-1 sm:py-2 bg-white/20 hover:bg-white/30 rounded-lg text-xs sm:text-sm text-white transition">
