...
<body class="bg-primary-50 p-6 min-h-screen">
    ...
    <div class="max-w-4xl mx-auto bg-white p-4 sm:p-6 shadow-xl rounded-xl border border-primary-200 mt-11">
        <!-- Header Section -->
        ...
        <div class="flex flex-wrap gap-3">
            <a href="view_timesheet.php?id=<?php echo $trainee_id; ?>" class="group flex items-center justify-center py-2.5 px-4 bg-secondary-500 hover:bg-secondary-600 text-white font-medium rounded-lg transition-colors duration-200 shadow-md hover:shadow-lg">
                <i class="fas fa-arrow-left mr-2 transform group-hover:-translate-x-1 transition-transform duration-200"></i>
                Back to Trainee Timesheet
            </a>
        </div>
    </div>
