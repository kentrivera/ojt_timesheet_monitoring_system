...
<body class="bg-primary-50 p-6 min-h-screen">
    ...
    <div class="max-w-4xl mx-auto bg-white p-4 sm:p-6 shadow-xl rounded-xl border border-primary-200">
        ...
        <div class="flex flex-wrap gap-3">
            <a href="coordinator_view_details.php?id=<?php echo $trainee_id; ?>" class="group flex items-center justify-center py-2.5 px-4 bg-secondary-500 hover:bg-secondary-600 text-white font-medium rounded-lg transition-colors duration-200 shadow-md hover:shadow-lg">
