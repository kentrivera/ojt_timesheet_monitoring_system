...
<body class="bg-gray-50">
                            ...
                            <div class="border-b border-gray-200 hover:bg-gray-50 transition duration-150">
                                ...
                                <div class="block md:hidden p-4">
                                    ...
                                    <div class="mt-3 flex space-x-2">
                                        <a href="coordinator_view_details.php?id=<?php echo $row['id']; ?>"
                                        ...
                                        <a href="../coordinators/view_timesheet.php?id=<?php echo $row['id']; ?>"
    ...
    <script>
        ...
        document.getElementById('searchTraineeBtn').addEventListener('click', function(e) {
            ...
            xhr.open('GET', 'coordinator_search_trainee.php?search_trainee=' + encodeURIComponent(searchQuery), true);
